...
import {root, reactFrontend} from '../../util/pathutil.js'
...
export default (async function(options) {
    ...
    app.use('/static/wiki', markdownServe.middleware({
        rootDirectory: root('node_modules/@devicefarmer/stf-wiki'),
        view: 'docs'
    }))
    ...
    app.use('/', serveStatic(reactFrontend('dist'), {fallthrough: true}))
    app.use('/assets', serveStatic(reactFrontend('dist/assets')))
    app.use('/locales', serveStatic(reactFrontend('dist/locales')))
